    ...
    <div className="min-h-screen bg-black text-white selection:bg-[#FF007F] selection:text-white">
      <Navigation />
       <main>
          <RobotHero />
          <RobotFeatures />
<section className="py-24 bg-[#FF007F]">
        ...
        <section className="py-24 bg-black border-y border-zinc-900">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <button className="px-10 py-4 bg-[#FF007F] text-black font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-[0_0_20px_rgba(255,0,127,0.3)]">
