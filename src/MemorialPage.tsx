    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white pt-16 pb-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          {/* Memorial Card */}
          <div className="bg-gray-900 rounded-2xl overflow-hidden shadow-2xl shadow-pink-500/30 border-4 border-pink-500 rounded-xl mb-12">

            {/* Image Section with Border Shrinking to Image */}
            <div className="flex justify-center py-8">
              <div className="inline-block border-4 border-pink-500 rounded-xl p-2 bg-black">
                <div className="relative h-96 w-auto overflow-hidden rounded-lg flex items-center justify-center">
                  <ImageWithFallback
                    src={clareGreenlaw}
                    alt="Clare Greenlaw"
