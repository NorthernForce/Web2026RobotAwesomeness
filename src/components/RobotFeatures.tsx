  ...
  const features = [
    {
      ...
      icon: <Cpu className="text-[#db3e79]" size={32} />,
    ...
    },
    {
      ...
      icon: <Zap className="text-[#db3e79]" size={32} />,
            ...
            >
              <div className="flex-1 space-y-6">
                <div className="flex items-center gap-4">
                  <div className="p-4 bg-zinc-900 border border-[#db3e79]/30 rounded-full">
                    {feature.icon}
                  </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3 text-sm text-zinc-300">
                    <div className="w-1.5 h-1.5 bg-[#db3e79]"></div>
