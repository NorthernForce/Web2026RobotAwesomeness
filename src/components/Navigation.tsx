...
export function Navigation() {
  ...
  return (
    <nav className="bg-black border-b-4 border-[#db3e79] sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-center gap-8 h-20">
          ...
          <Link to="/" className="flex-shrink-0 hover:opacity-80 transition-opacity">
            <img src="./images/172_logo_new_color.png" alt="Northern Force 172 Logo" className="w-16 h-16 object-contain" />
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 ml-2 pl-2 border-l border-gray-700">
              <a
                ...
                className="text-white hover:text-[#db3e79] transition-colors p-2"
              >
